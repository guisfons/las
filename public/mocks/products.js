...
var RAW_PRODUCTS = [
    {
        ...
        description: 'As Lâminas de Serra ACF Medical possuem design único feito a laser e dentes em formato prismado polidos em cerâmica, garantindo total precisão e corte ideal do osso.',
        ...
        detail: {
            ...
            general_information: 'Para cirurgias de: Artroplastia de Joelho, Quadril, Ombro e Cirurgias de Revisão, cirurgias cardíacas, Trauma ACL (Ligamento Cruzado Anterior), Cirurgias de Mão, Pé e Pulso. As lâminas estão disponíveis para todos os engates dos motores: Aesculap, AO Synthes, De Soutter, Linvatec, Hall, MicroAire, Otyker, Stryker.',
            technical_data: [],
    ...
    },
    {
        ...
        brands: ['ACF Medical'],
        logo_brand: '/images/brands/acf_medical_logo.png',
        description: 'É composto por Serra e Perfurador, a combinação perfeita de design e performance.',
        ...
        detail: {
            ...
            general_information: 'Artroplastia (Joelho, quadril, ombro, Punho, mão tornozelo e pé), Cirurgia de amputação, Cirurgia de trauma',
            technical_data: [],
    ...
    // },
    {
        ...
        description: 'O CellColt® é composto por um Kit de Cânulas que fazem a sucção de células mesenquimais de forma seletiva e fechada, criando um fluxo exclusivamente posterior e radial. Esta característica minimiza a diluição do aspirado de medula com o sangue periférico potencializando terapias de regeneração tecidual.',
        ...
        detail: {
            ...
            links: [
                {
                    ...
                    file_name: 'A Comparative Quantification in Cellularity of Bone Marrow Aspirated',
                    type: 'ARTICLES',
                },
                {
                    title: 'CellColt',
                    url: '/pdfs/Artigos/Cellcolt/A systematic review of the concept and clinical applications.pdf',
                    file_name: 'A systematic review of the concept and clinical applications',
                    type: 'ARTICLES',
                },
                {
                    title: 'CellColt',
                    url: '/pdfs/Artigos/Cellcolt/Anatomy of the ilium for bone marrow aspiration map of sectors.pdf',
                    file_name: 'Anatomy of the ilium for bone marrow aspiration map of sectors',
                    type: 'ARTICLES',
                },
                {
                    title: 'CellColt',
                ...
                },
                {
                    ...
                    file_name: 'Bone Marrow Aspirate Clot A Useful Technique in Diagnosis and Fallow-up of Hematological Disorders',
                    type: 'ARTICLES',
                },
                {
                    title: 'CellColt',
                ...
                },
                {
                    ...
                    file_name: 'CellColt - RecoveryCell - sistema de microaspiração multiradial de medula óssea autóloga (M-BMA)',
                    type: 'ARTICLES',
                },
                {
                    title: 'CellColt',
            ...
            testimonial: {
                testimonial: '“Utilizei o Cellcolt algumas vezes, trata-se de um produto de fácil aplicabilidade para o médico, ele nos proporciona uma coleta maior de células mesenquimais por possuir orifícios laterais na extremidade da cânula e permitir a retirada do BMA de vários níveis diferentes.”',
                testimonial_pictures: [
    ...
    },
    {
        ...
        detail: {
            ...
            general_information: 'O aspirado intraósseo pode ser utilizado em uma ampla variedade de procedimentos, em especial nas áreas de Ortopedia, Bucomaxilofacial, Coluna e Fisiatria. Ele pode ser combinado com matrizes ósseas, cartilagens e enxertos de todos os tipos, apresentando excelentes resultados em diversas intervenções. Entre os principais benefícios clínicos estão:,  , Alívio da dor, Tratamento da artrite, Abordagem da artrose, Terapia para tendinopatias, Tratamento de lesões ligamentares, Regeneração de disco intervertebral, Tratamento de Feridas',
            technical_data: [
            ...
            testimonial: {
                testimonial: '”O CellHarvest com seus furos laterais me permite uma coleta de material de alta qualidade e mais rápida, com menos sangue periférico, e ainda aumenta a segurança ao minimizar a fragmentação óssea.”',
                testimonial_pictures: [],
                doctor: {
    ...
    },
    {
        ...
        description: 'O EasyCore Hip é um sistema híbrido completo para a descompressão do núcleo da cabeça femoral do quadril, para o tratamento minimamente invasivo dos dois primeiros estágios (pré-colapso) da necrose avascular do quadril. O sistema é composto por um kit de instrumentais amplos e uma lâmina de descompressão expansível de uso único.',
        ...
        detail: {
            ...
            general_information: 'Descompressão do núcleo da cabeça femoral para o tratamento minimamente invasivo dos dois primeiros estágios (pré-colapso) da necrose avascular do quadril.',
            technical_data: [
    ...
    },
    {
        ...
        description: 'Composto pelo Kit de Cânulas especialmente desenvolvidas para a Osteocondroplastia do Joelho.',
        ...
        detail: {
            ...
            general_information: 'Osteocondroplastia: Solução cirúrgica, minimamente invasiva e percutânea, que tem como objetivo preencher os defeitos ósseos subcondrais e tratar as lesões da medula óssea do joelho através da injeção de substituto em pasta no local da lesão.',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
                [
                    'Modelos',
    ...
    },
    {
        ...
        detail: {
            ...
            general_information: 'Tratamento de Osteoplastia, Microfraturas e Lesão tipo "Edema do Osso Subcondral", Fratura subcondral, Alteração do Trabeculado Ósseo, Alteração da Massa Óssea ou preenchimento de cistos/defeitos ósseos com Injeção Percutânea do Substituto Ósseo de Fosfato de Cálcio;',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
            ...
            links: [
                {
                    ...
                    file_name: 'LAS Folheto Easyfill Small Joints Agosto 2023 Visualizacao',
                    type: 'CATALOG',
                },
                {
                    title: 'Kit Descartável De Osteocondroplastia Para Pequenas Articulações Macom – Easy Fill Small Joints',
    ...
    },
    {
        ...
        detail: {
            ...
            general_information: 'Utilizado durante cirurgias de tendões e/ ou de nervos periféricos para revestir tecidos cirurgicamente traumatizados., Funciona como uma barreira protetora temporária para separar os tecidos e reduzir a fibrose e a formação de aderências pós-cirúrgicas. Indicado para: Cirurgias da Mão, Cirurgias do Joelho, Cirurgias de Ombro e Cotovelo, Cirurgias do Pé & Tornozelo',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
            ...
            links: [
                {
                    ...
                    file_name: 'Prevention Of Peritendinous Adhesions After Tenolysis by Means Of A Carboxy-Methylcellulose (CMC)',
                    type: 'ARTICLES',
                },
                {
                    title: 'Dynavisc',
                ...
                },
                {
                    ...
                    file_name: 'Efficacy of Anti-adhesion gel of CMC with PEO on peripheral nerve experimental results',
                    type: 'ARTICLES',
                },
                {
                    title: 'Dynavisc',
                    ...
                    file_name: 'Prevention of perineural fibrosis after neurolysis and carboxymethylcellulose polyethileneoxide barrier agent f',
                    type: 'ARTICLES',
                },
                {
                    title: 'Dynavisc',
                ...
                },
                {
                    ...
                    file_name: 'Dynavisc_Closed Rupture of extensor hallucis longus_dr Franco Bassetto',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Dynavisc',
                ...
                },
                {
                    ...
                    file_name: 'Dynavisc Irregular Nodule on the Flexor Tendons dr Gustavo Mantovani',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Dynavisc',
            ...
            testimonial: {
                testimonial: '“As aderências pós-operatórias sempre foram a maior complicação nas cirurgias, e sempre pensávamos nos benefícios que traria um produto que impedisse isso. O Dynavisc veio suprir essa necessidade, mostrando bons resultados desde o início.”',
                testimonial_pictures: [
    ...
    },
    {
        ...
        brands: ['Fziomed'],
        logo_brand: '/images/brands/fziomed.png',
        description: 'O Interpose é um gel barreira de adesão bioabsorvível para cirurgia de coluna, pronto para ser usado, de aplicação fácil e rápida.',
        imageUrl: '/images/products/produto_banner_Interpose_Gel_AntiAdesao_Cirurgia_Coluna_Embalagem1.png',
        detail: {
            subtitle: '',
            ...
            general_information: 'O Interpose destina-se a ser colocado em torno do tecido neural após cirurgia de coluna para reduzir a formação de adesão e relatos de sintomas, como a dor. O Interpose é formulado a partir da tecnologia de biomateriais – combinação absorvível de: Carboximetilcelulose (CMC) e Óxido de Polietileno (PEO).',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
            ...
            links: [
                {
                    ...
                    file_name: 'Clinical Assessment of a CMC and PEO gel to inhibit postoperative epidural ashesion formation after discectomy',
                    type: 'ARTICLES',
                },
                {
                    title: 'Interpose',
                ...
                },
                {
                    ...
                    file_name: 'Prevention of peri­neural fibrosis after neurolysis and carboxy­methy',
                    type: 'ARTICLES',
                },
                {
                    title: 'Interpose',
                    url: '/pdfs/Artigos/Interpose/Reduction of leg pain by Oxiplex Gel after lumbar discectomy.pdf',
                    file_name: 'Reduction of leg pain by Oxiplex Gel after lumbar discectomy',
                    type: 'ARTICLES',
                },
                {
                    title: 'Interpose',
    ...
    },
    {
        ...
        imageUrl: '/images/products/produto_banner_Oxiplex_AP_Gel_Barreira_AntiAdesao_Cirurgia_Geral_Embalagem.png',
        detail: {
            subtitle: '',
            ...
            general_information: 'Cirurgias Peritoneais ,Cirurgias Ginecológicas (Adesiólise, Cirurgia Ovariana, Cirurgia Tubária, Miomectomia, Tratamento da Endometriose, Histerectomia)',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
            ...
            links: [
                {
                    ...
                    file_name: 'Oxiplex AP - Lundorff - Clinical Evaluation (Laparoscopy)',
                    type: 'ARTICLES',
                },
                {
                    title: 'Oxiplex AP',
                    url: '/pdfs/Artigos/Oxiplex_AP/Oxiplex AP - Lundorff - Young Reduction of Postoperative (Laparoscopic).pdf',
                    file_name: 'Oxiplex AP - Lundorff - Young Reduction of Postoperative (Laparoscopic)',
                    type: 'ARTICLES',
                },
                {
                    title: 'Oxiplex AP',
                    url: '/pdfs/Relatos_de_caso/Oxiplex_AP/Oxiplex_AP_Dr Patrick Bellelis_Endometriosis-Complications-1.pdf',
                    file_name: 'Oxiplex AP Dr Patrick Bellelis_Endometriosis-Complications-1',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Oxiplex AP',
                ...
                },
                {
                    ...
                    file_name: 'OxiplexAP_Dr.-Tcherniakovsky_Videolaparoscopic-Treatment-of-De',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Oxiplex/AP',
    ...
    },
    {
        ...
        imageUrl: '/images/products/produto_banner_Oxiplex_IU_Gel_AntiAdesao_Cirurgia_Intrauterina_Embalagem.png',
        detail: {
            subtitle: '',
            ...
            general_information: 'Projetado e indicado para uso em cirurgia intrauterina. Adesiólise, Síndrome de Asherman, Miomectomia, Polipectomia, Dilatação e Curetagem, Produtos retidos da concepção, Cirurgia do Septo Uterino',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
            ...
            links: [
                ...
                },
                {
                    ...
                    file_name: 'Oxiplex IU - Difficult Hysteroscopic Surgery and Intrauterine Carboxymethyl Cellulose Polyethylene Oxide Dual Polymer Gel Res',
                    type: 'ARTICLES',
                },
                {
                    title: 'Oxiplex IU',
                    ...
                    file_name: 'Oxiplex IU - DiSpiezio - Efficacy of a Polyethylene Oxide–Sodium Carboxymethylcellulose Gel in Prevention of Intrauterin',
                    type: 'ARTICLES',
                },
                {
                    title: 'Oxiplex IU',
                    url: '/pdfs/Artigos/Oxiplex_IU/Oxiplex IU - Fuchs - Intercoat OxiplexAP Gel for Preventing Intrauterine Adhesions.pdf',
                    file_name: 'Oxiplex IU - Fuchs - Intercoat OxiplexAP Gel for Preventing Intrauterine Adhesions',
                    type: 'ARTICLES',
                },
                {
                    title: 'Oxiplex IU',
                ...
                },
                {
                    ...
                    file_name: 'Dra Marcia Penteado Case Report hyteroscopic metroplasty and myomectomy',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Oxiplex IU',
                ...
                },
                {
                    ...
                    file_name: 'Dr. Kondo  Intrauterine Adhesions and Pelvic Endometriosis',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Oxiplex IU',
                ...
                },
                {
                    ...
                    file_name: 'Dr.Kelm Hysteroscopic Treatment of Retained Products of Conception',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Oxiplex IU',
                    url: '/pdfs/Relatos_de_caso/Oxiplex_IU/OxiplexIU_Adhesions_Following_MIUA_with_Partial_Uterine_Septum_dr Cunha.pdf',
                    file_name: 'Dr Cunha Adhesions Following MIUA with Partial Uterine Septum',
                    type: 'CASE_REPORTS',
                },
                {
                    title: 'Oxiplex/IU',
    ...
    },
    {
        ...
        description: 'O Gripper é um dispositivo auto retrátil, patenteado mundialmente, que permite aos cirurgiões ortopedistas executarem a cirurgia de forma procedimentalizada e posicionar/fixar os afastadores com segurança, fornecendo maior visibilidade, estabilidade e segurança para a operação.',
        ...
        detail: {
            ...
            general_information: 'Cirurgias Quadril (Com destaque à ATQ – Acesso Via Anterior), Cirurgias Joelho, Cirurgias Pé & Tornozelo, Cirurgias Coluna',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
    ...
    },
    {
        ...
        detail: {
            ...
            general_information: 'Destina-se à cobertura protetora do paciente. O EsySuit™ foi projetado para estabelecer e manter um campo estéril durante o procedimento cirúrgico, e contribui para reduzir o risco de infecção. A peça única permite aplicar o EsySuit™ de forma rápida e fácil.',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
                [
                    'Nome Comercial',
    ...
    },
    {
        ...
        description: 'A linha de monitores de nervos intra-operatórios Neurosign V4 é destinada a reduzir o risco de danos nos nervos em procedimentos cirúrgicos.',
        ...
        detail: {
            ...
            general_information: 'Com 4 canais, o Neurosign V4 é um equipamento (com os eletrodos, sensores e probes) que auxilia os cirurgiões ao monitorizar múltiplos nervos cranianos, periféricos e cervicais em tempo real em diversos procedimentos. Permite que o cirurgião identifique e localize o tecido neural delicado com precisão. Destina-se a: neurocirurgia, cirurgia maxilofacial, cirurgia de cabeça e pescoço e otorrinolaringologia em geral.',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
                [
    ...
    },
    {
        ...
        brands: ['Neurosign'],
        logo_brand: '/images/brands/neurosign.png',
        description: 'Dissector e Estimulador Tipo Tesoura foi desenhado para estimular os nervos enquanto disseca, o que reduz o risco de lesão do nervo e melhora a eficiência por reduzir o tempo cirúrgico gasto na troca de instrumentais.',
        ...
        detail: {
            ...
            general_information: 'Adequado para uso em monitores de nervos multicanais, Ideal para cirurgias de tireoide e paratireoide.',
            technical_data: [],
    ...
    },
    {
        ...
        description: 'PerOssal® é um substituto ósseo absorvível bioativo e osteocondutor desenvolvido para a reparação e preenchimento de defeitos ósseos. Sua estrutura única microporosa, garante a absorção uniforme de substâncias líquidas (como antibióticos). No tratamento de osso infectado ou contaminado, o PerOssal® é indicado após a realização de desbridamento cirúrgico, acompanhado da administração simultânea de antibióticos seja de forma sistêmica ou local.',
        ...
        detail: {
            ...
            general_information: 'PerOssal® é indicado para preenchimento ou reparação de defeitos ósseos.Possíveis áreas de aplicação,Traumatologia,Cirurgia ortopédica,Cirurgia da coluna,Cirurgia maxilofacial,Em caso de osso infectado ou contaminado, PerOssal® é indicado após desbridamento cirúrgico prévio e com administração simultânea de antibióticos de maneira sistêmica e/ou local.PerOssal® pode ser usado para aumento de osso autógeno.',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
                [
                    'Modelos Comerciais',
            ...
            links: [
                ...
                },
                {
                    ...
                    file_name: 'Sambri et al_2023 (PerOssal in singel satge chronic osteomyelitis)',
                    type: 'ARTICLES',
                },
                {
                    title: 'PerOssal',
                    url: '/pdfs/Artigos/Perossal/Scharf et al_2023.pdf',
                    file_name: 'Scharf et al_2023 (PerOssal Distal Radius Fracture Children)',
                    type: 'ARTICLES',
                },
                {
                    title: 'PerOssal',
                ...
                },
                {
                    ...
                    file_name: 'Tuleubayev and Rudenko_2021 (PerOssal AB release in rabbit)',
                    type: 'ARTICLES',
                },
                {
                    title: 'PerOssal',
    ...
    },
    {
        ...
        brands: ['Osartis'],
        logo_brand: '/images/brands/osartis_logo.png',
        description: 'PulsaClean® é um sistema de lavagem pulsátil, fornecido totalmente estéril e descartável, com eficácia clinicamente comprovada para procedimentos ortopédicos e desbridamento de feridas, realizando uma intensa limpeza do leito ósseo e teciduais.',
        ...
        detail: {
            ...
            general_information: 'Artroplastia total de joelho e quadril – cimentado e não cimentado, Revisões de artroplastias, Intervenções cirúrgicas, Limpeza de feridas',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
    ...
    },
    {
        ...
        description: 'O QuickDraw é um sistema de coleta universal com ferramentas de acesso para a coleta de enxerto ósseo autólogo através de uma incisão percutânea mínima na crista ilíaca.',
        ...
        detail: {
            ...
            links: [
                ...
                },
                {
                    ...
                    file_name: '2) Iliac-Crest-Bone-Graft-Harvesting-Techniques-A-comparison',
                    type: 'ARTICLES',
                },
                {
                    title: 'QuickDraw',
                ...
                },
                {
                    ...
                    file_name: '6) Patients Cannot Reliably Distinguish the Iliac Crest Bone Graft Donor Site From the Contralateral Side After Lumbar Spine Fusion',
                    type: 'ARTICLES',
                },
                {
                    title: 'QuickDraw',
                    url: '/pdfs/Artigos/Quickdraw/A retrospective study of iliac crest bone grafting techniques.pdf',
                    file_name: 'A retrospective study of iliac crest bone grafting techniques',
                    type: 'ARTICLES',
                },
                {
                    title: 'QuickDraw',
                ...
                {
                    title: 'Cânula coletora de enxerto autólogo com ponta cortante QuickDraw',
    ...
    },
    {
        ...
        detail: {
            ...
            general_information: 'Principais Indicações, Tumor de fígado, Nódulo/Tumor Tireoide Benígno ou Malígno, Mioma Uterino, Osteoma Osteóide, Nódulos/Tumor de Mama, Câncer Pulmão ou Nódulo Pulmonar, Câncer de Rim, Câncer de Próstata, Metástase Ossea',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
                [
                    'Modelos Disponíveis',
    ...
    },
    {
        ...
        description: 'O SafeView ™, Sistema Endoscópico de Liberação de Tecidos Moles, oferece aos cirurgiões mais controle e reduz a complexidade cirúrgica. A tecnologia patenteada da cânula transparente oferece visualização 360 ° e segurança incomparável.',
        ...
        detail: {
            ...
            general_information: 'O sistema SafeView ™ é indicado na liberação endoscópica de: Membros Superiores: Túnel do Carpo e Túnel Cubital, Membros Inferiores: Fascite Plantar, Ressecção do Gastrocnêmio e Túnel Tarsal',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
            ...
            links: [
                ...
                {
                    title: 'Kit Safeview – Sistema Endoscópico De Liberação De Tecidos Moles',
                    url: '../images/use-instruction/80517190033-SafeView-A.pdf',
                    file_name: 'Anvisa nº 80517190033',
                    type: 'DIRECTIONS_FOR_USE',
                },
                {
                    title: 'Kit Safeview-R – Sistema Endoscópico De Liberação De Tecidos Moles, Corte Reverso',
    ...
    },
    {
        ...
        detail: {
            ...
            general_information: 'Indicações, Dores discogênicas, Hérnia de Disco, Dor Ciática, Radiculopatia de Membro Inferior, Radiculopatia de Membro Superior, Dor Cervical, Dor Lombar, Estenose Foraminal, Artrose Facetária',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
            ...
            links: [
                ...
                },
                {
                    ...
                    file_name: '2008_Spinal Decompression Measurement of Treatment Outcomes',
                    type: 'ARTICLES',
                },
                {
                    title: 'SpineMED',
                    url: '/pdfs/Artigos/SpineMED/2009_Clinical Report. Spinal Decompression Measurement of Treatment Outcomes.pdf',
                    file_name: '2009_Clinical Report. Spinal Decompression Measurement of Treatment Outcomes',
                    type: 'ARTICLES',
                },
                {
                    title: 'SpineMED',
                ...
                },
                {
                    ...
                    file_name: '2011_A multimodal treatment Approach using Spinal Decompression via SpineMED',
                    type: 'ARTICLES',
                },
                {
                    title: 'SpineMED',
                    url: '/pdfs/Artigos/SpineMED/2012_Effect-of-Decompression-Therapy-Combined-with-Joint-Mobilization.pdf',
                    file_name: '2012_Effect-of-Decompression-Therapy-Combined-with-Joint-Mobilization',
                    type: 'ARTICLES',
                },
                {
                    title: 'SpineMED',
                ...
                },
                {
                    ...
                    file_name: '2013_Short-term Effect of SpineMED Decompression System for Lumbar Disc Herniation',
                    type: 'ARTICLES',
                },
                {
                    title: 'SpineMED',
                ...
                },
                {
                    ...
                    file_name: '2024_Assessment of SpineMED® Traction Effect on Cervical Disc Herniat',
                    type: 'ARTICLES',
                },
                {
                    title: 'Spinemed',
    ...
    // },
    {
        ...
        description: 'Eletrodo de agulha com revestimento NSTC. Estéril e de uso único',
        ...
        detail: {
            ...
            general_information: 'Este produto pode ser usado para todos os procedimentos cirúrgicos em que os benefícios clínicos da aplicação monopolar (corte de tecidos e/ou hemostasia) foram já comprovados.',
            technical_data: [
                ['Categoria', 'Item', 'Descrição'],
    ...
    },
    {
        ...
        brands: ['Osartis'],
        logo_brand: '/images/brands/osartis_logo.png',
        description: 'Cimento ósseo de PMMA de alta viscosidade e secagem rápida para utilização em cirurgia óssea. A mistura de dois componentes estéreis individuais produz um cimento ósseo dúctil que, após o seu endurecimento, fixa o implante e transfere uniformemente para o osso as tensões produzidas durante o movimento.',
    ...
    },
    {
        ...
        description: 'É uma terapia de ácido hialurônico de uma única injeção que proporciona um alívio duradouro da dor da osteoartrite leve à moderada do joelho e quadril.¹',
        ...
        detail: {
            ...
            general_information: 'Injeção intra-articular para o tratamento sintomático de osteoartrite ou osteoartrose leve à moderada do joelho ou do quadril.',
            technical_data: [
...
exports.ALL_PRODUCTS = RAW_PRODUCTS.map(function (product) { return (__assign(__assign({}, product), { slug: (0, slugify_1.slugify)(product.name) })); });
