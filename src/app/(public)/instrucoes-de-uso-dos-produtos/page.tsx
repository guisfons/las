...
const products = [
  {
    ...
    anvisa: '80517190022',
    fileUrl: '/pdfs/instructions/Laminas-ACF.pdf',
  },
  {
    brand: 'ACF Medical',
    name: 'Lâminas para Serra Cirúrgica',
    anvisa: '80517199006',
    fileUrl: '/pdfs/instructions/Laminas-Cirurgicas.pdf',
  },
  {
    brand: 'ACF Medical',
    name: 'Sistema de Ferramenta Elétrica Cirúrgica',
    anvisa: '80517199007',
    fileUrl: '/pdfs/instructions/Serra-e-Perfurador-ACF.pdf',
  },
  {
    brand: 'CellColt MDL',
    name: 'Kit Cirúrgico CellColt',
    anvisa: '80517199005',
    fileUrl: '/pdfs/instructions/CellColt.pdf',
  },
  {
    brand: 'CellColt Care',
    name: 'CellColt Care',
    anvisa: '80517199008',
    fileUrl: '/pdfs/instructions/Rev01.pdf',
  },
  {
    brand: 'CellHarvest',
    name: 'CellHarvest',
    anvisa: '80517199011',
    fileUrl: '/pdfs/instructions/Rev.02-1.pdf',
  },
  {
    brand: 'EasyCore Hip',
    name: 'EasyCore Hip',
  ...
  },
  {
    ...
    anvisa: '80517199001',
    fileUrl: '/pdfs/instructions/Lamina-EasyCore.pdf',
  },
  {
    brand: 'EasyCore Hip',
    name: 'Kit Cânula Para Necrose Avascular Do Quadril',
    anvisa: '10243070088',
    fileUrl: '/pdfs/instructions/Kit-Canula-Avascular-do-Quadril.pdf',
  },
  {
    brand: 'EasyFill',
  ...
  },
  {
    ...
    name: 'Dynavisc',
    anvisa: '80517190037',
    fileUrl: '/pdfs/instructions/IFU_Dynavisc_02402B-Draft.pdf',
  },
  {
    brand: 'Fziomed',
    name: 'Interpose',
    anvisa: '80517190034',
    fileUrl: '/pdfs/instructions/IFU_Interpose_02391B-Draft.pdf',
  },
  {
    brand: 'Fziomed',
    name: 'Oxiplex/AP',
    anvisa: '80517190041',
    fileUrl: '/pdfs/instructions/OXIPLEX-AP.pdf',
  },
  {
    brand: 'Fziomed',
    name: 'Oxiplex/IU',
    anvisa: '80517190040',
    fileUrl: '/pdfs/instructions/Oxiplex-IU.pdf',
  },
  {
    brand: 'MedEnvision',
    name: 'Retrator de Acesso Cirúrgico – GRIPPER',
    anvisa: '80517190032',
    fileUrl: '/pdfs/instructions/Gripper.pdf',
  },
  {
    brand: 'MedEnvision',
    name: 'Afastadores Cirúrgicos MedEnvision',
    anvisa: '80517190039',
    fileUrl: '/pdfs/instructions/afast-gripper.pdf',
  },
  {
    brand: 'MedEnvision',
    name: 'EsySuit',
  ...
  },
  {
    ...
    anvisa: '80517190004',
    fileUrl: '/pdfs/instructions/PROBES.pdf',
  },
  {
    brand: 'Neurosign',
    name: 'Eletrodo de Laringe',
    anvisa: '80517190005',
    fileUrl: '/pdfs/instructions/eletrodo-laringe.pdf',
  },
  {
    brand: 'Neurosign',
    name: 'Eletrodo Estéril para Neurosign',
    anvisa: '80517190006',
    fileUrl: '/pdfs/instructions/eletrodo-agulha.pdf',
  },
  {
    brand: 'Neurosign',
    name: 'Eletrodo Cirúrgico para Neurosign Magstim',
    anvisa: '80517190007',
    fileUrl: '/pdfs/instructions/eletrodos-cirurgicos.pdf',
  },
  {
    brand: 'Neurosign',
