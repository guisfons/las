...
interface GerarSaudeClientProps {
  pageData: WPPageNode | null;
}

export default function GerarSaudeClient({ pageData }: GerarSaudeClientProps) {
  ...
  return (
    <>
      ...
      <BannerLas
        ...
        link="https://www.lasforlife.com.br/sobre-nos/#nossa-cultura"
