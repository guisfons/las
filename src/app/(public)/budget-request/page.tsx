      ...
      <section className="w-full max-w-7xl px-3 pt-36 mx-auto flex flex-col gap-6 py-12">
        <header className="flex flex-col gap-6">
          ...
          <p className="max-w-2xl w-11/12 mx-auto font-exo2 text-lg text-label text-center">
            Nossa equipe especializada está pronta para entender suas
            necessidades e apresentar como nossos produtos podem agregar valor
            ao seu trabalho. Preencha o formulário abaixo e construiremos juntos
            uma proposta personalizada para sua região e especialidade.
          </p>
        </header>
